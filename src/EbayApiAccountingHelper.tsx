...
{/* Connection Status Cards - eBay & FreeAgent Brand Colors WITH ACTION BUTTONS */}
<div className="bg-white border-2 border-gray-200 rounded-xl p-6 mb-6 shadow-sm">
  ...
  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
    ...
    {/* eBay Status - Enhanced with Action Button */}
<div className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-300 rounded-lg p-4">
  ...
  {(user?.ebayConnection?.isConnected || connections.ebay.isConnected) ? (
    ...
    {/* FreeAgent Status - Enhanced with Action Button */}
    ...
    {/* Bank Account Status - FreeAgent Green Theme (No action button needed) */}
    ...
    {/* System Status - Neutral/Success Colors (No action button needed) */}
